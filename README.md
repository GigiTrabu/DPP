# Graph Anonymization & Link Re-identification Project
...
To run the entire pipeline (Anonymization, Attacks, Privacy/Utility Analysis, and Complexity Benchmarks) in one go, simply execute the bash script from the root folder:
*`run.bash`*
